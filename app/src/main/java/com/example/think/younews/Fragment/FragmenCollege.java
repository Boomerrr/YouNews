...
import com.example.think.younews.Adapter.NewsAdapter;
...
import com.example.think.younews.Presenter.CollegePresenter;
import com.example.think.younews.R;

import java.util.ArrayList;
import java.util.List;

public class FragmenCollege extends BaseFragment implements IView,NewsAdapter.OnItemClickListener{
    ...
    protected View initView() {
        View view=View.inflate(mContext, R.layout.fragment_college,null);
